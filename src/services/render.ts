...
<head>
  ...
  <title>${title}</title>
  <meta name="description" content="TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations. Operator surface in the Kinetic Gain Suite." />
  ...
  <link rel="canonical" href="https://campaigns.kineticgain.com/" />
  <link rel="icon" type="image/svg+xml" href="${KG_FAVICON_DATA_URI}" />
  <meta property="og:type" content="website" />
  <meta property="og:site_name" content="Kinetic Gain" />
  <meta property="og:title" content="${title}" />
  <meta property="og:url" content="https://campaigns.kineticgain.com/" />
  <meta property="og:description" content="TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations. Operator surface in the Kinetic Gain Suite." />
  <meta name="twitter:card" content="summary" />
  <meta name="twitter:title" content="${title}" />
  <meta name="twitter:description" content="TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations. Operator surface in the Kinetic Gain Suite." />
  <script type="application/ld+json">{"@context":"https://schema.org","@graph":[{"@type":"ProfessionalService","@id":"https://campaigns.kineticgain.com/#service","name":"Kinetic Gain — TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations","url":"https://campaigns.kineticgain.com/","areaServed":"United States","description":"TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations. Operator surface in the Kinetic Gain Suite."},{"@type":"WebSite","@id":"https://campaigns.kineticgain.com/#website","url":"https://campaigns.kineticgain.com/","name":"TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations","publisher":{"@type":"Organization","name":"Kinetic Gain LLC"}}]}</script>
  <style>${KG_STYLE01_CSS}${KG_COMPAT_CSS}</style>
</head>
<body>
  <header>
    <div class="wrap nav">
      <a class="kg-logo" href="/" aria-label="Kinetic Gain — TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations">
        ${KG_MARK_SVG}
        <span class="kg-word">Kinetic Gain</span>
      </a>
      <nav class="nav-links" id="primaryNav">
        <a href="/taxonomy-lane">Taxonomy Lane</a>
        <a href="/audience-risks">Audience Risks</a>
    ...
    <div class="wrap">
      <div class="foot-top">
        <div>
          ...
          <p class="foot-tag">TypeScript governor for campaign taxonomy, naming discipline, audience mappings, launch-safe conventions, and buyer-facing growth operations — operator surface in the Kinetic Gain Suite. Static demo data; no live calls.</p>
        </div>
        <div class="foot-cols">
          <div class="foot-col">
            <h4>Estate</h4>
          ...
          <div class="foot-col">
            <h4>This surface</h4>
            <a href="https://github.com/mizcausevic-dev/campaign-taxonomy-governor">GitHub repo</a>
          </div>
        </div>
      </div>
      <div class="foot-bot">
